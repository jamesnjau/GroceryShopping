...
import 'package:grocery/widgets/products/bottom_sheet_container.dart';
          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width: 10),
                if (offer > 0) //If offer is available anly
                  Text(
            ...
            Container(
              child: Padding(
                padding: const EdgeInsets.only(top: 8, bottom: 8),
                child:
                    Text('Other product info', style: TextStyle(fontSize: 20)),
              ),
            ),
            Divider(color: Colors.grey[400]),
            Padding(
