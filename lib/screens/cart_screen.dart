...
import 'package:grocery/services/order_services.dart';
import 'package:grocery/services/store_service.dart';
import 'package:grocery/services/user_services.dart';
import 'package:grocery/widgets/cart/cart_list.dart';
import 'package:grocery/widgets/cart/cod_toggle.dart';
import 'package:grocery/widgets/cart/coupon_widget.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var _payable = (_cartProvider.subTotal + deliveryFee - discount).toInt();
    ...
    _orderServices.saveOrder({
      ...
      _cartServices.deleteCart().then((value) {
        _cartServices.checkData().then((value) {
          EasyLoading.showSuccess('Your order was submitted');
