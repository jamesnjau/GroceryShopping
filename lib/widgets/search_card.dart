          ...
          children: [
            Stack(
              children: [
                  ...
                  child: InkWell(
                    onTap: () {
                      pushNewScreenWithRouteSettings(context,
                          ...
                          screen:
                              ProductDetailsScreen(document: product.document),
                          withNavBar: false,
                ...
                if (product.document!.data()['comparedPrice'] >
                ...
                children: [
                  Container(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(product.document!.data()['brand'],
                            style: TextStyle(fontSize: 10)),
                        SizedBox(height: 6),
                        Text(product.document!.data()['productName'],
                        ...
                        Container(
                            ...
                            child: Text(product.document!.data()['weight'],
                                style: TextStyle(
                                    fontSize: 12,
